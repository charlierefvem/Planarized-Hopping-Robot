...
##Kinetics
x₁ = x₀ + xₛ(t)- Lᵦ*sin(θ₁(t)+θ₃(t)) - Lₐ*sin(θ₁(t))
x₁ = x₀ + xₛ(t) - Lᵦ*sin(θ₁(t)+θ₃(t)) - (Lₐ-L₁)*sin(θ₁(t))
x₂ = x₀ + xₛ(t)- (Lᵦ-L₂)*sin(θ₁(t)+θ₃(t))

y₁ = y₀ + yₛ(t) + Lᵦ*cos(θ₁(t)+θ₃(t)) + Lₐ*cos(θ₁(t))
y₁ = y₀ + yₛ(t) + Lᵦ*cos(θ₁(t)+θ₃(t)) + (Lₐ-L₁)*cos(θ₁(t))
y₂ = y₀ + yₛ(t) + (Lᵦ-L₂)*cos(θ₁(t)+θ₃(t))
...
## Lagrangian
L = T - V
w = τ₁*θ₁(t) + τ₃*θ₃(t) - c₁*θ̇₁(t)*θ₁(t) - c₂*θ̇₃(t)*θ₃(t) - cₛₓ*yₛ(t)*ẏₛ(t) - cₛ*xₛ(t)*ẋₛ(t)
